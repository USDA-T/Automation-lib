...
public class CoreWait {
    ...
    public static void waitForVisibilityOfAllElements(WebDriverWait wdriver, List<WebElement> elements) {
    ...
    public static void waitForTextToBePresentInElementLocated(WebDriverWait wdriver, By locator, String text) {
        wdriver.until(ExpectedConditions.textToBePresentInElementLocated(locator, text));
    }

    public static void waitForTextToBePresentInElementValue(WebDriverWait wdriver, By locator, String text) {
    ...
    public static void waitForFrameToBeAvailableAndSwitchToIt(WebDriverWait wdriver, String frameLocator) {
